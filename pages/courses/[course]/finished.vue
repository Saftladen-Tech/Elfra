  ...
  <div class="flex flex-col grow justify-center items-center">
    <div data-testid="contentwrapper" class="flex flex-col justify-center items-center text-center space-y-12">
      <div class="max-w-[800px] flex flex-col space-y-5">
        <h1 class="sm:text-8xl text-7xl font-semibold">Kurs beendet!</h1>
        <p class="sm:text-4xl text-xl">Herzlichen glückwunsch! Du kannst den Kurs nun erneut durcharbeiten oder Abschließen!</p>
      </div>
      <div data-testid="icon" class="dark:text-success-500 text-success-700">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512" stroke-width="1.5" stroke="currentColor" class="sm:size-64 size-44">
